...
static void SimpleObjectExample() {
    ...
    NSString *bookJSON = [book modelToJsonObject];
    NSLog(@"Book: %@", bookJSON);
}
...
static void NestObjectExample() {
    ...
    NSString *repoJSON = [repo modelToJsonObject];
    NSLog(@"Repo: %@", repoJSON);
}
...
static void ContainerObjectExample() {
    ...
    NSString *albumJSON = [album modelToJsonObject];
...
static void CustomMapperExample() {
    ...
    NSString *messageJSON = [message modelToJsonObject];
